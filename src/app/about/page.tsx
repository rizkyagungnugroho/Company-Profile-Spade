...
export default function About() {
  return (
    <>
      <section className="max-w-6xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-10">
          ...
          <div className="flex-1 max-w-xl">
            ...
            <p className="text-gray-500 mb-6">Spade Gaming Space</p>
          ...
          <div className="flex-shrink-0 w-64 h-80 relative rounded-lg overflow-hidden">
            <Image
              src="/assets/logo.png" // ganti sesuai path gambar kamu
              alt="Portrait"
              fill
      ...
      {/* Section bawah: Play now dengan animasi dan desain baru */}
