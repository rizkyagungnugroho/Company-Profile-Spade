      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <div className="space-y-5 mb-8">
            <div>
              <h3 className="font-semibold text-gray-800">Anti Lag</h3>
              <p className="text-gray-600 text-sm">
                Body text for whatever you'd like to expand on the main point.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800">Equipment terbaik</h3>
              <p className="text-gray-600 text-sm">
                Body text for whatever you'd like to say. Add main takeaway points, quotes, anecdotes.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800">Group Community</h3>
              <p className="text-gray-600 text-sm">
          ...
          <div className="flex flex-wrap gap-4">
            <button className="px-5 py-2 bg-black text-white text-sm rounded-lg hover:bg-gray-800 transition">
              Book now
            </button>
            <button className="px-5 py-2 border border-gray-400 text-sm rounded-lg hover:bg-gray-100 transition">
              Join Group
            </button>
          </div>
        </motion.div>
